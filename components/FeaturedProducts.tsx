                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-6">
                    ...
                    <Button
                      ...
                      className="electric-gradient text-white font-semibold px-6 py-3 rounded-xl group lightning-border hover:lightning-glow transition-all duration-300"
                    >
        ...
        <div className="text-center mt-16">
          <Link href="/boutique">
            <Button 
              variant="outline" 
              size="lg"
              className="border-white/20 text-white hover:bg-white/5 px-8 py-4 rounded-xl lightning-border hover:lightning-glow transition-all duration-300"
            >
